...
-- Business Question:
-- Generate a detailed report showing each customer's name, email, total number of orders placed,
...
-- Business Question:
-- For each product category, show the category name, number of different products sold,
...
-- Business Question:
-- Show monthly sales trends for the year 2024. For each month, display the month name,
...
GROUP BY
    MONTH(o.order_date), DATE_FORMAT(o.order_date, '%M')
ORDER BY
    MONTH(o.order_date);
